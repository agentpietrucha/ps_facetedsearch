<form method="post" class="form-horizontal">
  <div class="panel">
        ...
        <tr>
          <td class="form-group fixed-width-xs">
            <div class="md-checkbox md-checkbox-inline">
              <label>
                <input type="checkbox" name="product_subgroup_products_ids[]" value="{$product->id}" />
          ...
          <td class="">
            <div class="btn-group-action">
              <div class="btn-group pull-right">
                <a href="{$current_url}&amp;delete_product_subgroup_product=1&amp;product_id={(int)$product->id}" class="btn btn-default">
    ...
    <div class="panel-footer">
      <button class="btn btn-default pull-right" type="submit" name="submit_bulk_product_subgroup_products_delete"><i class="icon-trash"></i> {l s='Bulk remove' d='Modules.Facetedsearch.Admin'}</button>
    </div>
  </div>
</form>
<div class="panel">
